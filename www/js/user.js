...
function userRegister(){
    ...
    $('#userForm').submit(function(){
        ...
        $.post('https://recyclewaste406.000webhostapp.com/api.php?module=user&task=storeAll', $(this).serialize(), function(data){
...
function Login(){
    ...
    var userApi = "https://recyclewaste406.000webhostapp.com/api.php?module=user&task=loginAll";
...
var articleData;
(function() {
    var newsAPI = "https://recyclewaste406.000webhostapp.com/api.php?module=event&task=listAll";
    $.getJSON( newsAPI)
    .done(function( data ) {
        if(data.status==200){
            $("#newslist").empty();
...
function book(){
    ...
    $('#userForm').submit(function(){
        ...
        $.post('https://recyclewaste406.000webhostapp.com/api.php?module=event&task=bookAll', $(this).serialize(), function(data){
