...
$.post('https://recyclewaste406.000webhostapp.com/api.php?module=waste&task=storeAll', $(this).serialize(), function(data){
...
var articleData;
(function() {
var newsAPI = "https://recyclewaste406.000webhostapp.com/api.php?module=waste&task=listAll";
$.getJSON( newsAPI)
.done(function( data ) {
if(data.status==200){
$("#newslist").empty();
...
var articleData;
(function() {
var newsAPI = "https://recyclewaste406.000webhostapp.com/api.php?module=time&task=listAll";
$.getJSON( newsAPI)
.done(function( data ) {
if(data.status==200){
$("#newslist").empty();
